 ...
 *{{box-sizing:border-box}} body{{margin:0;background:var(--bg);color:var(--ink);
 ...
 .titleblock{{display:flex;justify-content:space-between;align-items:center;gap:28px;flex-wrap:nowrap;margin:16px 0 0}}
  ...
  <div class="toprow">
    ...
    <div class="actions">
      <a class="gh" href="{_REPO_URL}" target="_blank" rel="noopener" title="Aleph on GitHub">
        ...
        GitHub &#8599;</a>
      <a class="gh" href="{_KEY_DOCS}">How to get an API key &#8599;</a>
      <a class="keylink" href="mailto:{_SUPPORT_MAILTO}" title="Request a model or get support">Get support</a>
    </div>
  </div>
...
<footer><div class="footer-inner">
  ...
  <div class="credit">Vulcan cluster operated by <a href="https://www.ualberta.ca">University of Alberta</a> /
    ...
    <span class="l2"><a href="{_KEY_DOCS}">How to get an API key</a> · <a href="mailto:{_SUPPORT_MAILTO}" title="Request a model or get support">Get support</a>.</span></div>
</div></footer>
<script>
