"""medgemma-27b-it comprehensive gateway test.
...
Run externally via the gateway VIP + Tyk auth (preferred):
  GW_URL=http://<GATEWAY_VIP> TYK_KEY=<key> MODEL=medgemma-27b-it python3 models/medgemma-27b-it/test.py

Run inside the gateway pod (legacy, no auth needed):
  cat models/medgemma-27b-it/test.py | \
      kubectl exec -i -n models deploy/model-gateway -c gateway -- env MODEL=medgemma-27b-it python3 -
"""
...
MODEL = os.environ.get("MODEL", "medgemma-27b-it")
results = []
