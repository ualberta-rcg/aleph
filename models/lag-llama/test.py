"""lag-llama test — POST /v1/science/forecast {context, prediction_length}.

Lag-Llama probabilistic forecast over a numeric series. Sanity: mean non-empty + finite.
Run: GW_URL=https://inference.vulcan.alliancecan.ca TYK_KEY=<key> GW_INSECURE=1 MODEL=lag-llama python3 models/lag-llama/test.py
"""
