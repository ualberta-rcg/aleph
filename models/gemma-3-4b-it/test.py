"""gemma-3-4b-it comprehensive gateway test.
...
Run externally via the gateway VIP + Tyk auth (preferred):
  GW_URL=http://<GATEWAY_VIP> TYK_KEY=<key> MODEL=gemma-3-4b-it python3 models/gemma-3-4b-it/test.py

Run inside the gateway pod (legacy, no auth needed):
  cat models/gemma-3-4b-it/test.py | \
