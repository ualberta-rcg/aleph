"""aya-expanse-8b chat gateway test.

Template A battery (trimmed, non-reasoning text-only chat).
Run: GW_URL=https://inference.vulcan.alliancecan.ca TYK_KEY=<key> GW_INSECURE=1 MODEL=aya-expanse-8b python3 models/aya-expanse-8b/test.py
"""
...
MODEL = os.environ.get("MODEL", "aya-expanse-8b")
results = []
