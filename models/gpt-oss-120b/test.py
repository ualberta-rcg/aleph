...
# 3. Thinking default (should reason — effort=medium default)
def t03():
...
# 4. Thinking low (minimal reasoning)
def t04():
...
# 23. Anthropic thinking enabled (maps to effort=medium)
def t23():
...
def t24():
    ...
    # Should either work (ignoring image) or return error — just needs 200 or 400
...
################################################################
print("\n" + "=" * 60, flush=True)
print("GPT-OSS-120B Gateway Test", flush=True)
print("=" * 60 + "\n", flush=True)
