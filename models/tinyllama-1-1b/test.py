"""tinyllama-1-1b comprehensive gateway test.
...
Run externally via the gateway VIP + Tyk auth (preferred):
  GW_URL=http://<GATEWAY_VIP> TYK_KEY=<key> MODEL=tinyllama-1-1b python3 models/tinyllama-1-1b/test.py

Run inside the gateway pod (legacy, no auth needed):
  cat models/tinyllama-1-1b/test.py | \
      kubectl exec -i -n models deploy/model-gateway -c gateway -- env MODEL=tinyllama-1-1b python3 -
"""
