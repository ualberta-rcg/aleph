"""biomedbert-large embedding gateway test (run inside the gateway pod).

Embedding (Template C) battery for a custom transformers server (Microsoft BiomedBERT-large, GPU).
...
T1 = "Trastuzumab, a monoclonal antibody, targets HER2-positive breast cancer."
T2 = "GLP-1 receptor agonists improve glycemic control in type 2 diabetes."
T3 = "CRISPR-Cas9 enables precise editing of the human genome."
...
def truncation():
    long_text = "biomedical literature pharmacology treatment " * 200
