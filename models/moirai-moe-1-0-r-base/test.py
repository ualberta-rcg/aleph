"""moirai-moe test — POST /v1/forecast {time_series, prediction_length}.

Salesforce Moirai-MoE (mixture-of-experts) forecasts a numeric series. Sanity: forecast.mean non-empty
+ finite.
Run: GW_URL=https://inference.vulcan.alliancecan.ca TYK_KEY=<key> GW_INSECURE=1 MODEL=moirai-moe-1-0-r-base python3 models/moirai-moe-1-0-r-base/test.py
"""
...
MODEL = os.environ.get("MODEL", "moirai-moe-1-0-r-base")
ENDPOINT = "/v1/forecast"
PAYLOAD = {"model": MODEL, "time_series": [10 + i * 0.7 + (i % 5) for i in range(96)], "prediction_length": 24}
results = []
