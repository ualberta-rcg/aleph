...
check("System prompt", *post("/v1/chat/completions", {"model": model, "messages": [{"role": "system", "content": "You are a medical expert."}, {"role": "user", "content": "What is hypertension?"}], "max_tokens": 120}))
check("High temperature", *post("/v1/chat/completions", {"model": model, "messages": [{"role": "user", "content": "Tell a medical joke"}], "max_tokens": 80, "temperature": 1.5}))
...
check("Short max_tokens", *post("/v1/chat/completions", {"model": model, "messages": [{"role": "user", "content": "About medical imaging"}], "max_tokens": 10}))
...
# Reasoning effort ignored (non-reasoning model)
print()
