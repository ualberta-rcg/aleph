"""openbiollm-70b comprehensive gateway test.
...
Run externally via the gateway VIP + Tyk auth (preferred):
  GW_URL=http://<GATEWAY_VIP> TYK_KEY=<key> MODEL=openbiollm-70b python3 models/openbiollm-70b/test.py

Run inside the gateway pod (legacy, no auth needed):
  cat models/openbiollm-70b/test.py | \
      kubectl exec -i -n models deploy/model-gateway -c gateway -- env MODEL=openbiollm-70b python3 -
"""
...
MODEL = os.environ.get("MODEL", "openbiollm-70b")
results = []
