"""qwen25-vl-72b-awq comprehensive gateway test.
...
Run externally via the gateway VIP + Tyk auth (preferred):
  GW_URL=http://<GATEWAY_VIP> TYK_KEY=<key> MODEL=qwen25-vl-72b-awq python3 models/qwen25-vl-72b-awq/test.py

Run inside the gateway pod (legacy, no auth needed):
  cat models/qwen25-vl-72b-awq/test.py | \
      kubectl exec -i -n models deploy/model-gateway -c gateway -- env MODEL=qwen25-vl-72b-awq python3 -
"""
...
MODEL = os.environ.get("MODEL", "qwen25-vl-72b-awq")
results = []
