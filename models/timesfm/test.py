"""timesfm test — POST /v1/forecast {values, horizon}.

Google TimesFM forecasts a numeric series (mean + median + quantiles). Sanity: mean non-empty + finite.
Run: GW_URL=https://inference.vulcan.alliancecan.ca TYK_KEY=<key> GW_INSECURE=1 MODEL=timesfm python3 models/timesfm/test.py
"""
...
MODEL = os.environ.get("MODEL", "timesfm")
ENDPOINT = "/v1/forecast"
PAYLOAD = {"model": MODEL, "values": [10 + i * 0.7 + (i % 5) for i in range(96)], "horizon": 24}
results = []
