"""Gateway test battery for Alchemi BGR NIM."""
...
MODEL = os.environ.get("MODEL", "alchemi-bgr-nim")
KSVC = os.environ.get("KSVC", f"{MODEL.replace('-nim','')}-predictor")
# BGR native endpoint already lives under /v1, so no prefix stripping is needed.
UPSTREAM = os.environ.get("UPSTREAM", f"http://{KSVC}.models.svc.cluster.local")
ENDPOINT = os.environ.get("ENDPOINT", "/v1/infer")
