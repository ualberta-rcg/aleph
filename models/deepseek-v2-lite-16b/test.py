...
# Self-signed edge (cert-manager.local) — opt out of TLS verification with GW_INSECURE=1.
_CTX = ssl._create_unverified_context() if os.environ.get("GW_INSECURE", "").lower() in ("1", "true", "yes", "on") else None
