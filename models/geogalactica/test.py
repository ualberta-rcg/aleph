"""geogalactica comprehensive gateway test.
...
Run externally via the gateway VIP + Tyk auth (preferred):
  GW_URL=http://<GATEWAY_VIP> TYK_KEY=<key> MODEL=geogalactica python3 models/geogalactica/test.py

Run inside the gateway pod (legacy, no auth needed):
  cat models/geogalactica/test.py | \
      kubectl exec -i -n models deploy/model-gateway -c gateway -- env MODEL=geogalactica python3 -
"""
...
MODEL = os.environ.get("MODEL", "geogalactica")
results = []
