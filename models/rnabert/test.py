"""rnabert RNA-embedding gateway test (run inside the gateway pod).

Embedding (Template C) battery for a custom server (multimolecule RNA-BERT, GPU).
768-dim mean-pooled RNA embeddings. OpenAI /v1/embeddings added 2026-06-19; /v1/science/embed kept.

Run:  cat models/rnabert/test.py | kubectl exec -i -n models deploy/model-gateway -c gateway -- python3 -
"""
import httpx, json, os, time

G = "http://localhost:8080"
MODEL = os.environ.get("MODEL", "rnabert")
EXP_DIM = 120
MAX_INPUT = 440
results = []
