"""astrosage comprehensive gateway test (run inside the gateway pod).
...
Run:  cat models/astrosage/test.py | \
      kubectl exec -i -n models deploy/model-gateway -c gateway -- env MODEL=astrosage python3 -
"""
import httpx, json, os, time

G = "http://localhost:8080"
MODEL = os.environ.get("MODEL", "astrosage")
results = []
