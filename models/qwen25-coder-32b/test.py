"""qwen25-coder-32b comprehensive gateway test.
...
Run externally via the gateway VIP + Tyk auth (preferred):
  GW_URL=http://<GATEWAY_VIP> TYK_KEY=<key> MODEL=qwen25-coder-32b python3 models/qwen25-coder-32b/test.py

Run inside the gateway pod (legacy, no auth needed):
  cat models/qwen25-coder-32b/test.py | \
      kubectl exec -i -n models deploy/model-gateway -c gateway -- env MODEL=qwen25-coder-32b python3 -
"""
...
MODEL = os.environ.get("MODEL", "qwen25-coder-32b")
results = []
